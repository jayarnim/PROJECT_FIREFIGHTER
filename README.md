...
- `낙상` 총소방지수가 981건으로 가장 높았음

- `낙상` 총소방지수가 다른 사고유형의 총소방지수보다 압도적으로 높음

  - 모든 사고유형의 소방지수를 종합한 총소방지수는 2827건임
  - `낙상` 총소방지수는 전체 총소방지수의 약 34.70%를 차지함
  - 두 번째로 높은 `질병외` 총소방지수는 239건임
  - `낙상` 총소방지수는 `질병외` 총소방지수의 약 4배임

- `농기계사고`, `날씨사고`, `성폭행` 총소방지수는 0건임
...
- 총소방지수와 건당 평균유동인구수 간 양의 상관관계가 존재한다고 볼 수 없음
